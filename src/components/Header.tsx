import { Bookmark, Database, Map as MapIcon } from "lucide-react";
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex-1 min-w-0">
            <Link to="/" className="block hover:opacity-80 transition-opacity">
              ...
              <h2
                className="text-sm md:text-base font-display text-amber-400 tracking-wider"
                style={{ textShadow: "0 0 8px rgba(255,185,40,0.4)" }}
              >
          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              <Database
                className={`w-3.5 h-3.5 ${location.pathname === "/summits" ? "text-amber-400" : "text-teal-400"}`}
              />
            </Link>
            <Link
              to="/nearby"
            ...
            >
              <MapIcon
                className={`w-3.5 h-3.5 ${location.pathname === "/nearby" ? "text-blue-400" : "text-teal-400"}`}
              />
            </Link>
            <Link
              to="/bookmarks"
            ...
            >
              <Bookmark
                className={`w-3.5 h-3.5 ${location.pathname === "/bookmarks" ? "text-amber-400" : "text-teal-400"}`}
              />
              {bookmarkCount > 0 && (
