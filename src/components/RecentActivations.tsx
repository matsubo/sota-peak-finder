  ...
  if (error) {
    return (
      <div className="card-technical rounded p-6 animate-fade-in border-l-4 border-l-orange-500/50">
        <div className="text-sm font-mono-data text-orange-400/80">{t("activations.error")}</div>
      </div>
    );
  }
  ...
  return (
    <div className="card-technical rounded p-6 animate-fade-in">
      ...
      {activations.length === 0 ? (
        <div className="text-sm font-mono-data text-gray-500">{t("activations.noActivations")}</div>
      ) : (
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {activations.map((activation) => (
                <tr key={activation.id} className="border-b border-gray-700/50 hover:bg-teal-500/5">
