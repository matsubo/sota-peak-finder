import { ArrowLeft, ChevronLeft, ChevronRight, Loader, Radio } from "lucide-react";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`SOTA activation history for ${callsign || "activator"}`}
        />
      </Helmet>
              ...
              <div className="grid grid-cols-3 gap-4 animate-fade-in">
                <div className="card-technical rounded p-4">
                  <div className="text-xs font-mono text-teal-400/60 mb-1">
                    {t("activator.totalActivations")}
                  </div>
                  <div className="text-2xl font-mono-data text-cyan-400">
                    {allActivations.length}
                  </div>
                </div>

                <div className="card-technical rounded p-4">
                  <div className="text-xs font-mono text-teal-400/60 mb-1">
                    {t("activator.totalQsos")}
                  </div>
                          ...
                          {activations.map((activation) => (
                            ...
                            >
                              <td className="py-3 px-2 font-mono-data text-gray-300">
                                {formatDateShort(activation.ActivationDate, i18n.language)}
                              </td>
                              <td className="py-3 px-2">
                                <Link
                                  to={summitPath(activation.SummitCode)}
