...
import { ArrowLeft, Home, Flag as Mountain, Search } from "lucide-react";
          ...
          <div className="mt-8 pt-6 border-t border-teal-500/10">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500 font-mono-data space-y-1">
                <div>
                  Database: <span className="text-green-400">ONLINE</span>
                </div>
                <div>
                  Service Worker: <span className="text-green-400">ACTIVE</span>
                </div>
                <div>
                  Offline Mode: <span className="text-cyan-400">AVAILABLE</span>
                </div>
              </div>
            </div>
          </div>
